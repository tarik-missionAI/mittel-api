...
# Test 11: Legacy endpoint compatibility
echo "1️⃣1️⃣  Test Legacy Endpoint (backward compatibility)"
echo "---"
echo "Testing /api/v1/cdr (old format)..."
curl -s "$API_URL/api/v1/cdr?limit=2" | python3 -m json.tool | head -30
echo "✅ Legacy endpoints still work!"
echo ""
